                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!Fs.exists("./customerData/" + accountID + ".json")) {
                                ...
                                console.log("Configura\u00E7\u00E3o padr\u00E3o do novo contato \"" + accountID + "\" criada.");
                            }
                            ...
                            return [4 /*yield*/, sendMessageWTyping({
                                    text: variableMessage_1.variableMessage(botMsgs.bemVindoClienteAntigo1, botMsgs.bemVindoClienteAntigo2, botMsgs.bemVindoClienteAntigo3, botMsgs.bemVindoClienteAntigo14)
                                }, accountID)];
                        case 1:
                            //send non newcomer message
                            _a.sent();
