...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
function salvarConfgChat(nomeArquivo, dados) {
    var nome = "./".concat(nomeArquivo, ".json");
    Fs.writeFile(nome, JSON.stringify(dados), function (err) {
        if (err)
            throw err;
        log("O arquivo de config foi salvo! ID: ".concat(nomeArquivo));
    });
}
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
// start a connection
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!Fs.exists("./customerData/".concat(accountID, ".json"))) {
                        ...
                        salvarConfgChat("./customerData/".concat(accountID, ".json"), customerDataTemplate);
                    ...
                    customerDataRaw = readFromFile("./customerData/".concat(accountID, ".json"));
