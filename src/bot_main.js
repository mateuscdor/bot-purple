        ...
        return __generator(this, function (_a) {
            ...
            sock.ev.on("connection.update", function (update) {
                ...
                if (connection === "close") {
                    ...
                    (0, log_1.log)("connection closed due to ", lastDisconnect.error, ", reconnecting ", shouldReconnect);
                    // reconnect if not logged out
                    if (shouldReconnect) {
                        connectToWhatsApp();
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, log_1.log)("replying to", m.messages[0].key.remoteJid);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!filesystem_1["default"].exists("./customerData/".concat(accountID, ".json"))) {
                                (0, log_1.log)("NOVO CLIENTE/CONTATO DETECTADO: ".concat(accountID));
                                ...
                                (0, log_1.log)("Configura\u00E7\u00E3o padr\u00E3o do novo contato \"".concat(accountID, "\" criada."));
                                sendMessageWTyping(accountID, botMsgs.bemVindoNovoCliente);
                            }
                            if (!filesystem_1["default"].exists("./customerData/".concat(accountID, ".json"))) return [3 /*break*/, 2];
                            customerDataRaw = (0, readFromFile_1.readFromFile)("./customerData/".concat(accountID, ".json"));
                            customerData = JSON.parse(customerDataRaw);
                            (0, log_1.log)("Configura\u00E7\u00E3o padr\u00E3o do novo contato \"".concat(accountID, "\" criada."));
                            (0, log_1.log)(customerData.accountID);
                            msgRandom = (0, variableMessage_1.variableMessage)(botMsgs.bemVindoClienteAntigo1, botMsgs.bemVindoClienteAntigo2, botMsgs.bemVindoClienteAntigo3, botMsgs.bemVindoClienteAntigo4);
                            msgRandomObj = {
                                text: msgRandom
                            };
            ...
            sock.ev.on("connection.update", function (update) {
                ...
                if (connection === "close") {
                    ...
                    if (((_b = (_a = lastDisconnect.error) === null || _a === void 0 ? void 0 : _a.output) === null || _b === void 0 ? void 0 : _b.statusCode) !==
                        ...
                        (0, log_1.log)("connection closed");
                    }
                }
                (0, log_1.log)("connection update", update);
            });
